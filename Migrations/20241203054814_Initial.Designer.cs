...
namespace ProblemAssignment3.Migrations
{
    ...
    [Migration("20241203054814_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProblemAssignment3.Entities.Customer", b =>
                {
            ...
            modelBuilder.Entity("ProblemAssignment3.Entities.Invoice", b =>
                {
            ...
            modelBuilder.Entity("ProblemAssignment3.Entities.InvoiceLineItem", b =>
                {
            ...
            modelBuilder.Entity("ProblemAssignment3.Entities.PaymentTerms", b =>
                {
                    b.Property<int>("PaymentTermsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProblemAssignment3.Entities.Invoice", b =>
                {
                    b.HasOne("ProblemAssignment3.Entities.Customer", "Customers")
                        .WithMany("Invoices")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProblemAssignment3.Entities.PaymentTerms", "PaymentTerms")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("ProblemAssignment3.Entities.InvoiceLineItem", b =>
                {
                    b.HasOne("ProblemAssignment3.Entities.Invoice", "Invoice")
