...
namespace ProblemAssignment3.Entities
{
    public class CustomerInvoiceDBContext: DbContext
    {
        ...
        {
            modelBuilder.Entity<Customer>().HasMany(c=>c.Invoices).WithOne(i=>i.Customers).HasForeignKey(i=>i.CustomerId);

            modelBuilder.Entity<Invoice>().HasMany(i=>i.InvoiceLineItems).WithOne(li=>li.Invoice).HasForeignKey(i=>i.InvoiceId);

            modelBuilder.Entity<Invoice>().HasOne(i=>i.PaymentTerms).WithMany(p=>p.Invoices).HasForeignKey(i=>i.PaymentTermsId);
            ...
            modelBuilder.Entity<PaymentTerms>().HasData(new PaymentTerms() { PaymentTermsId = 1, Description = "Net due 10 days", DueDays = 10 },
            ...
            modelBuilder.Entity<Invoice>().HasData(new Invoice() { InvoiceId = 1, InvoiceDate = new DateTime(2022, 8, 5), PaymentTermsId = 3, CustomerId = 1 },
            ...
            modelBuilder.Entity<InvoiceLineItem>().HasData(new InvoiceLineItem() { InvoiceLineItemId = 1, Description = "Part 123", Amount = 1089.99, InvoiceId = 1 },
